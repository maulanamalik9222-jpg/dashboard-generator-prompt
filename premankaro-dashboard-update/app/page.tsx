        ...
        <div className={kind === "bola" ? "grid footballGrid" : kind === "validasi" ? "grid validationGrid" : kind === "usdt" || kind === "result" ? "grid usdtGrid" : "grid"}>
          {kind === "bola" ? <section className="footballStudio">
            <div className="panel footballControls">
              <div className="footballSource"><small>LINK ACUAN PREDIKSI</small><a href={footballData?.sourceUrl || "https://bolapelangi2.jadwalbola.org/prediksi-bola-15-16-september-2026"} target="_blank" rel="noreferrer">↗ BUKA LINK ACUAN</a><span>Dashboard mengecek data baru otomatis setiap 30 menit.</span></div>
