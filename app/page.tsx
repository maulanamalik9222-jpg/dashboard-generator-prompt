    ...
    <AuthGate>
      ...
      >
        ...
        <style>{`
          ...
          .upLogo{position:absolute!important;z-index:4;left:50%;top:50%;display:block;width:86%!important;height:86%!important;max-width:220px!important;max-height:220px!important;margin:0!important;object-fit:contain!important;object-position:center center!important;transform-origin:center center;transform-style:preserve-3d;backface-visibility:hidden;animation:upLogoPrecision 6.5s ease-in-out infinite!important;filter:contrast(1.08) saturate(1.2) drop-shadow(0 14px 18px rgba(0,0,0,.65)) drop-shadow(0 0 10px rgba(0,217,255,.3)) drop-shadow(0 0 16px rgba(255,230,0,.16))!important}
          ...
          @keyframes upLogoPrecision{0%,100%{transform:translate(-50%,-50%) perspective(900px) rotateY(-7deg) rotateX(1deg) scale(.97)}25%{filter:contrast(1.12) saturate(1.32) brightness(1.08) drop-shadow(0 0 14px #00d9ff)}50%{transform:translate(-50%,-52%) perspective(900px) rotateY(7deg) rotateX(-1deg) scale(1.015)}75%{filter:contrast(1.12) saturate(1.32) brightness(1.09) drop-shadow(0 0 14px #ffe600)}}
