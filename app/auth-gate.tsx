  ...
  return (
    <>
      <div className="userBar">
        <i aria-hidden="true">{(user.name || user.email || "U").trim().charAt(0).toUpperCase()}</i>
        <span>
          <b>{user.name}</b>
          <small>{user.role === "admin" ? "MASTER" : user.staffRole === "assistant" ? "ASISTEN MASTER" : "STAFF"} · Sesi pengguna aktif</small>
        </span>
        <button
          onClick={() =>
      ...
      <style>{`
        ...
        .userBar{position:fixed!important;z-index:250!important;right:20px!important;top:82px!important;bottom:auto!important;display:flex!important;align-items:center!important;gap:11px!important;min-width:315px;padding:9px 10px 9px 11px!important;border:1px solid rgba(0,217,255,.28)!important;border-radius:16px!important;background:rgba(4,18,24,.94)!important;box-shadow:0 16px 38px rgba(0,0,0,.32),0 0 20px rgba(0,217,255,.06)!important;backdrop-filter:blur(14px)}
        .userBar>i{flex:0 0 40px;width:40px;height:40px;display:grid;place-items:center;border:1px solid rgba(0,217,255,.34);border-radius:50%;color:#001317;background:linear-gradient(145deg,#ffe600,#00d9ff,#00ffa8);font-family:"Lexend",Arial,sans-serif;font-size:14px;font-style:normal;font-weight:950;box-shadow:0 0 15px rgba(0,217,255,.18)}
        .userBar>span{display:grid!important;gap:3px;min-width:0;margin-right:auto;color:#efffff!important;font-family:"Lexend",Arial,sans-serif!important}.userBar>span b{max-width:175px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:11px;font-weight:900}.userBar>span small{color:#8daeb5;font-size:7px;font-weight:700;letter-spacing:.02em}
        .userBar>button{min-width:70px;padding:11px 13px!important;border:1px solid rgba(255,230,0,.35)!important;border-radius:10px!important;color:#f7fbfb!important;background:#17272d!important;font-family:"Lexend",Arial,sans-serif!important;font-size:9px!important;font-weight:900!important;cursor:pointer}.userBar>button:hover{color:#171407!important;background:linear-gradient(135deg,#ffe66b,#d6bb52)!important}
        [data-theme="light"] .userBar{border-color:rgba(50,139,153,.28)!important;background:rgba(247,252,252,.96)!important;box-shadow:0 14px 34px rgba(42,84,91,.14)!important}[data-theme="light"] .userBar>span{color:#1b3c43!important}[data-theme="light"] .userBar>span small{color:#627f85}[data-theme="light"] .userBar>button{color:#24464d!important;background:#e7eeee!important}
        ...
        @media(max-width:900px){.userBar{right:10px!important;top:68px!important;min-width:0;max-width:calc(100vw - 20px)}.userBar>span b{max-width:120px}.userManagementModal{inset:0;padding:18px}.userTableHead{display:none}.managementUserRow{grid-template-columns:1fr;gap:14px;padding:20px}.managementActions{justify-content:flex-start}.userManagementHead{padding:26px 22px}.managementUsers{max-height:none}.userManagementHead h2{font-size:27px!important}.menuAccessControl>div{grid-template-columns:1fr}}
      `}</style>
    </>
  );
}
